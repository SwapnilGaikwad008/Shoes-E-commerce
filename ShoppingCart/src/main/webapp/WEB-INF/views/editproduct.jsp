...
<div class="container" >
  ...
  <div class="col-lg-12 well">
    <div class="row">
    <form  action="editproduct" method="post" commandName="product" enctype="multipart/form-data" > 
      <div class="col-sm-12">
        <div class="row">
          <div>
  ...
  <label >Supplier-ID</label>
    ...
    <option>${list.id}</option>
         ...
         <div class="form-actions " style="float: right;margin:5px;">
    ...
    <div class="form-actions " style="float: right;margin-top:5px;">
